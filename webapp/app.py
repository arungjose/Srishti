...
with col2:
    ...
    features_df = pd.DataFrame({'Feature': ['Sepal Length', 'Sepal Width', 'Petal Length', 'Petal Width'],'Value (cm)': [sepal_length, sepal_width, petal_length, petal_width]})
...
with st.expander("📚 About the Iris Dataset"):
    st.markdown("""
    The Iris flower dataset is a classic dataset in machine learning and statistics introduced for showcasing categorical classification and prediction
